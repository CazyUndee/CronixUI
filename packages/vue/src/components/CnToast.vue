<template>
  <div v-if="visible" class="cn-toast">
    <div class="cn-toast-icon" :style="{ color: iconColors[type] }" v-html="icons[type]"></div>
    <div class="cn-toast-message">{{ message }}</div>
    <button class="cn-toast-close" @click="close" aria-label="Close">
